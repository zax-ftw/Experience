...
public:
	...
	struct Questing
	{
		...
		SETTING_INT(XPQuestType12, "Questing", 50);
		SETTING_INT(XPQuestType13, "Questing", 75);
		SETTING_INT(XPQuestType14, "Questing", 50);
		SETTING_INT(XPQuestType15, "Questing", 50);
		SETTING_INT(XPQuestType16, "Questing", 50);
		SETTING_INT(XPQuestType17, "Questing", 50);
		SETTING_INT(XPQuestType18, "Questing", 50);
		SETTING_INT(XPQuestType19, "Questing", 50);
		SETTING_INT(XPQuestType20, "Questing", 75);
		SETTING_INT(XPQuestType21, "Questing", 50);
		SETTING_INT(XPQuestType22, "Questing", 50);
		SETTING_INT(XPQuestType23, "Questing", 50);
		SETTING_INT(XPQuestType24, "Questing", 50);
		SETTING_INT(XPQuestType25, "Questing", 50);
		SETTING_INT(XPQuestType26, "Questing", 50);
		SETTING_INT(XPQuestType27, "Questing", 50);
		SETTING_INT(XPQuestType28, "Questing", 50);
		SETTING_INT(XPQuestType29, "Questing", 50);
		SETTING_INT(XPQuestType30, "Questing", 50);
		SETTING_INT(XPQuestType31, "Questing", 50);
		SETTING_INT(XPQuestType32, "Questing", 50);
		SETTING_INT(XPQuestType33, "Questing", 50);
		SETTING_INT(XPQuestType34, "Questing", 50);
		SETTING_INT(XPQuestType35, "Questing", 50);
		SETTING_INT(XPQuestType36, "Questing", 50);
		SETTING_INT(XPQuestType37, "Questing", 50);
		SETTING_INT(XPQuestType38, "Questing", 50);
		SETTING_INT(XPQuestType39, "Questing", 50);
		SETTING_INT(XPQuestType40, "Questing", 50);
		SETTING_INT(XPQuestType41, "Questing", 50);
		SETTING_INT(XPQuestType42, "Questing", 50);
		SETTING_INT(XPQuestType43, "Questing", 50);
		SETTING_INT(XPQuestType44, "Questing", 50);
		SETTING_INT(XPQuestType45, "Questing", 50);
		SETTING_INT(XPQuestType46, "Questing", 50);
		SETTING_INT(XPQuestType47, "Questing", 50);
		SETTING_INT(XPQuestType48, "Questing", 50);
		SETTING_INT(XPQuestType49, "Questing", 50);
		SETTING_INT(XPQuestType50, "Questing", 50);
		SETTING_INT(XPQuestType51, "Questing", 50);
		SETTING_INT(XPQuestType52, "Questing", 50);
		SETTING_INT(XPQuestType53, "Questing", 50);
		SETTING_INT(XPQuestType54, "Questing", 50);
		SETTING_INT(XPQuestType55, "Questing", 50);
		SETTING_INT(XPQuestType56, "Questing", 50);
		SETTING_INT(XPQuestType57, "Questing", 50);
		SETTING_INT(XPQuestType58, "Questing", 50);
		SETTING_INT(XPQuestType59, "Questing", 50);
		SETTING_INT(XPQuestType60, "Questing", 50);
		SETTING_INT(XPQuestType61, "Questing", 50);
	};
